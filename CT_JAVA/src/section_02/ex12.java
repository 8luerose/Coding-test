...
1. 경우의 수를 생각해라
    ...
    - ** M * N 먼저 떠올렸으면 그거부터 이중 for 만들어주고, 겉에 완탐 i,j 이중 for 감싸주는 것도 방법일지도? **
...
4. ** 이 문제의 핵심은, 문제에서 주어진 "3 4 1 2"에 빠져들 게 아니라, 1번 학생의 위치를 찾고, 2번 학생의 '위치를 찾아서 등수를 비교'하는 것이다 **
    - 위치 찾아서 등수 확인하고, n번의 시험에서 모두 통과했는지 '횟수 카운팅'해서 비교해주면 된다
    - 어렵게 백트래킹 그런 거 생각하지말고 우선 완탐으로 풀어보자 == 간단 ㄴㄴ 진짜 노가다 ㄱㄱ (야리끼리면 더 좋고)
...
1. 멘토가 멘티보다 등수가 높아야 한다
    ...
    - 일관된지 확인하기 위해, 'm번의 확인 검사 필요 + 각 시험에서 3번 학생의 등수와 4번학생의 등수가 필요'
